...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header aboutus-container py-5">
        <div class="container">
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p>
                        <b>Address: </b>Sesa Colony, Desai Nagar, Sanquelim Goa<br>
                        <b>Mobile No: </b>+91-8767507523, +91-832-2365124<br>
                        <b>Email: </b>sesaemployeessociety@gmail.com<br>
                    </p>
                    ...
                    <div class="bg-light p-5 h-100 d-flex align-items-center">
                        <form action="mail.php" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input class="btn btn-primary w-100 py-3" type="submit" name="submit">
                                </div>
                            </div>
                        </form>
                    </div>
